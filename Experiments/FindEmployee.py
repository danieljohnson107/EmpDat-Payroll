...
class FindEmployee(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        # Inputs
        gv.fNameInput.place(x=340, y=40, width=gv.inputWidth,
                         height=gv.inputHeight)
        gv.lNameInput.place(x=340, y=65, width=gv.inputWidth,
                         height=gv.inputHeight)
        gv.addressInput.place(x=340, y=90, width=gv.inputWidth,
                           height=gv.inputHeight)
        gv.addressTwoInput.place(x=340, y=115, width=gv.inputWidth,
                              height=gv.inputHeight)
        gv.cityInput.place(x=340, y=140, width=gv.inputWidth,
                        height=gv.inputHeight)
        gv.stateInput.place(x=340, y=165, width=gv.inputWidth,
                         height=gv.inputHeight)
        gv.zipInput.place(x=340, y=190, width=gv.inputWidth,
                       height=gv.inputHeight)
        gv.phoneInput.place(x=340, y=215, width=gv.inputWidth,
                         height=gv.inputHeight)
        gv.classInput.place(x=340, y=240, width=gv.inputWidth,
                         height=gv.inputHeight)
        gv.empNumInput.place(x=340, y=265, width=gv.inputWidth,
                          height=gv.inputHeight)
        gv.passwordInput.place(x=340, y=290, width=gv.inputWidth,
                            height=gv.inputHeight)
        gv.departmentInput.place(x=340, y=315, width=gv.inputWidth,
                              height=gv.inputHeight)
        gv.payRateInput.place(x=340, y=340, width=gv.inputWidth,
                           height=gv.inputHeight)
        gv.payYTDInput.place(x=340, y=365, width=gv.inputWidth,
                          height=gv.inputHeight)
        gv.securityInput.place(x=340, y=390, width=gv.inputWidth,
                            height=gv.inputHeight)

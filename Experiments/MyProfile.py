...
class MyProfile(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        gv.fNameInput.insert(0, globe.ud.read_value(emp_id, "first_name"))
        gv.lNameInput.insert(0, globe.ud.read_value(emp_id, "last_name"))
        gv.addressInput.insert(0, globe.ud.read_value(emp_id, "address"))
        # self.addressTwoInput.insert(0, ud.read_value(emp_id, ""))
        gv.cityInput.insert(0, globe.ud.read_value(emp_id, "city"))
        gv.stateInput.insert(0, globe.ud.read_value(emp_id, "state"))
        gv.zipInput.insert(0, globe.ud.read_value(emp_id, "zip"))
        # self.phoneInput.insert(0, ud.read_value(emp_id, ""))
        gv.classInput.insert(0, globe.ud.read_value(emp_id, "classification"))
        gv.empNumInput.insert(0, globe.ud.read_value(emp_id, "id"))
        gv.passwordInput.insert(0, globe.ud.read_value(emp_id, "password"))
        # self.departmentInput.insert(0, ud.read_value(emp_id, ""))
        gv.payRateInput.insert(0, globe.ud.read_value(emp_id, "hourly"))
        gv.payYTDInput.insert(0, globe.ud.read_value(emp_id, "salary"))
        gv.securityInput.insert(0, globe.ud.read_value(emp_id, "access"))

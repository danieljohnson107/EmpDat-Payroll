...
class LoginPage(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        login_button = Button(self, text="Login", width=gv.buttonWidth, height=gv.buttonHeight, bg=gv.buttonColor,
                              fg=gv.buttonTextColor, font=gv.fontProp, command=self.login_pressed)
        create_password_button = Button(self, text="Don't Have a Password?", width=gv.buttonWidth,
                                        height=gv.buttonHeight, bg=gv.buttonColor, fg=gv.buttonTextColor,
                                        font=gv.fontProp, command=lambda: controller.show_frame("ChangePassword"))

        self.user_entry = Entry(self, textvariable=self.name_var, font=gv.fontProp)
        self.password_entry = Entry(self, textvariable=self.passw_var, show="*", font=gv.fontProp)
